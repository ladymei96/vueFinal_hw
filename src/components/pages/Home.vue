...
<!-- 優惠券介紹 -->
    <div class="index-couponIntro-bg d-flex justify-content-center align-items-center">
      <div class="wow bounceOut index-couponIntro text-center text-white p-5" data-wow-delay=".2s">
        <h3>周末限定折扣</h3>
        <p>
